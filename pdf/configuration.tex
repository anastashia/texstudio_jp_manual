...
\section{LaTeX関連コマンドの設定}\label{sec:conf_latexcommand}
...
\nameref{sec:search}の段落で一般的なビューワーに対するいくつかのコマンド例が示されている。
...
補完単語リストに関するさらなる情報は、
%\hyperref[SECTION040]{補完}\hyperref[CWLDESCRIPTION]{cwl形式の解説}
\nameref{sec:completion}と\nameref{sec:desc_of_clw}の段落を参照のこと。
